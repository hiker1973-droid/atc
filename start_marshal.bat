...
start "Marshal" cmd /c "%~dp0atc.exe --marshal-only --airfield OMDM --marshal-freq 306.3 --marshal-voice ballad --srs-addr %SRS% --tacview-addr %TACVIEW% --eam-password %EAM% --dashboard-port 6004 --log-level %LOG%"
